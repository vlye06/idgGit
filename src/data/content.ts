...
const en: SiteContent = {
  ...
  contact: {
    ...
    form: {
      ...
      message: "Message",
      submit: "Send Message",
      success: "Thank you! Your email app should now open with your message ready to send — just hit send there to reach us.",
...
const ua: SiteContent = {
  ...
  contact: {
    ...
    form: {
      ...
      submit: "Надіслати",
      success: "Дякуємо! Зараз повинна відкритися ваша поштова програма з готовим листом — просто натисніть \"Надіслати\" там.",
